...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './text.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEXT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEXT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEXT actions', async () => {
      const expectedActions = [
        {
