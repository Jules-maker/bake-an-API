...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './image.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGE actions', async () => {
      const expectedActions = [
        {
