...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './meme.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEME_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEME actions', async () => {
      const expectedActions = [
        {
