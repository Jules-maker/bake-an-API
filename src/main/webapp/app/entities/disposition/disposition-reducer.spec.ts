...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISPOSITION actions', async () => {
      const expectedActions = [
        {
